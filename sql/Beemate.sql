...
CREATE TABLE thong_bao (
    ...
    CONSTRAINT fk_tb_tk FOREIGN KEY (tai_khoan_id) REFERENCES tai_khoan(id)
);
...
CREATE TABLE san_pham_yeu_thich (
    ...
    san_pham_id INT,
    ngay_tao DATETIME DEFAULT GETDATE(),
    CONSTRAINT fk_spyt_tk FOREIGN KEY (tai_khoan_id) REFERENCES tai_khoan(id),
    CONSTRAINT fk_spyt_sp FOREIGN KEY (san_pham_id) REFERENCES san_pham(id)
);
