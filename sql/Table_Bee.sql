...
CREATE TABLE khuyen_mai(
  ...
  so_luong INT NOT NULL, -- Tổng số lượng phát hành (Vd: 100)
  da_su_dung INT DEFAULT 0, -- Đã dùng bao nhiêu (Vd: 15). Mặc định là 0
  hinh_thuc BIT NOT NULL,
...
phuong_thuc_thanh_toan NVARCHAR(225) NOT NULL,
