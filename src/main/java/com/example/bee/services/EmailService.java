...
public class EmailService {
    ...
    public void sendOrderConfirmationEmail(HoaDon hoaDon, String emailKhachHang) {
        ...
        try {
            // Sử dụng MimeMessage thay cho SimpleMailMessage để hỗ trợ gửi định dạng HTML
            ...
            // 3. Định dạng lại tiền tệ
            String tongTienFormated = String.format("%,.0f", hoaDon.getGiaTong());

            // 4. Xây dựng nội dung Email bằng HTML và CSS Inline
            String htmlContent = """
            ...
            // Tham số 'true' ở đây chỉ định rằng nội dung email là HTML
