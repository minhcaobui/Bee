...
public class KhachHangService {
    ...
    public Page<Map<String, Object>> layDanhSachKhachHang(String q, Boolean trangThai, int page, int size) {
        Pageable pageable = PageRequest.of(page, size, Sort.by("id").descending());
        Page<KhachHang> pageData = khRepo.search(q, trangThai, pageable);
        return pageData.map(kh -> {
    ...
    public KhachHang layChiTietKhachHang(Integer id) {
        return khRepo.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Không tìm thấy khách hàng"));
    }

    @Transactional
    public ResponseEntity<?> taoMoiKhachHang(KhachHangRequest req) {
    ...
    @Transactional
    public ResponseEntity<?> capNhatKhachHang(Integer id, KhachHangRequest req) {
    ...
    public ResponseEntity<?> layHoaDonCuaKhachHang(Integer id, int page, int size, String q, String statusId) {
    ...
    public ResponseEntity<?> laySanPhamDaMua(Integer id, int page, int size) {
        ...
        for (HoaDon hd : completedOrders) {
            ...
            for (HoaDonChiTiet ct : details) {
                ...
                productStats.putIfAbsent(spctId, new HashMap<>(Map.of(
        ...
        List<Map<String, Object>> sortedList = new ArrayList<>(productStats.values());
    ...
    public ResponseEntity<?> layVoucherDaDung(Integer id, int page, int size) {
        List<HoaDon> orders = hoaDonRepository.findByKhachHangIdOrderByNgayTaoDesc(id);

        List<HoaDon> ordersWithVoucher = orders.stream()
        ...
        for (HoaDon hd : ordersWithVoucher) {
    ...
    public ResponseEntity<?> layDanhSachDiaChi(Integer id) {
    ...
    @Transactional
    public ResponseEntity<?> themDiaChiChoKhachHang(Integer id, DiaChiRequest req) {
        KhachHang kh = khRepo.findById(id)
    ...
    @Transactional
    public ResponseEntity<?> xoaDiaChi(Integer idDiaChi) {
    ...
    @Transactional
    public ResponseEntity<?> datDiaChiMacDinh(Integer idDiaChi) {
    ...
    @Transactional
    public ResponseEntity<?> doiMatKhauCaNhan(Map<String, String> request) {
        try {
    ...
    @Transactional
    public ResponseEntity<?> themDiaChiCaNhan(DiaChiRequest req, Authentication authentication) {
        String username = authentication.getName();
    ...
    @Transactional
    public ResponseEntity<?> capNhatDiaChiCaNhan(Integer id, DiaChiRequest req, Authentication authentication) {
    ...
    @Transactional
    public ResponseEntity<?> datDiaChiCaNhanMacDinh(Integer id, Authentication authentication) {
    ...
    public ResponseEntity<?> xoaDiaChiCaNhan(Integer idDiaChi, Authentication authentication) {
        DiaChiKhachHang dc = dcRepo.findById(idDiaChi)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND));
    ...
    public ResponseEntity<?> kiemTraYeuThich(Integer sanPhamId, Authentication authentication) {
        if (authentication == null || !authentication.isAuthenticated() || "anonymousUser".equals(authentication.getName())) {
    ...
    @Transactional
    public ResponseEntity<?> thayDoiYeuThich(Integer sanPhamId, Authentication authentication) {
        if (authentication == null || !authentication.isAuthenticated() || "anonymousUser".equals(authentication.getName())) {
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(Map.of("message", "Vui lòng đăng nhập!"));
        }
        KhachHang kh = khRepo.findByTaiKhoan_TenDangNhap(authentication.getName()).orElse(null);
    ...
    public ResponseEntity<?> layDanhGiaSanPham(Integer sanPhamId) {
    ...
    @Transactional
    public ResponseEntity<?> themDanhGia(Integer orderDetailId, DanhGiaRequest req, Authentication auth) {
    ...
    public ResponseEntity<?> layToanBoDanhGiaCuaToi(Authentication authentication) {
        if (authentication == null || !authentication.isAuthenticated())
            return ResponseEntity.ok(Collections.emptyList());
        KhachHang kh = khRepo.findByTaiKhoan_TenDangNhap(authentication.getName()).orElse(null);
        if (kh == null || kh.getTaiKhoan() == null) return ResponseEntity.ok(Collections.emptyList());
    ...
    @Transactional
    public ResponseEntity<?> adminDoiMatKhauChoKhach(Integer id, Map<String, String> body) {
    ...
    public ResponseEntity<?> kiemTraDieuKienDanhGia(Integer sanPhamId, Authentication authentication) {
        if (authentication == null || !authentication.isAuthenticated() || "anonymousUser".equals(authentication.getName())) {
        ...
        List<HoaDonChiTiet> purchasedDetails = new ArrayList<>();
    ...
    public ResponseEntity<?> xacThucOtp(String email, String otp) {
