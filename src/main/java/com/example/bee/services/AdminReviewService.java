...
public class AdminReviewService {
    ...
    public Page<ReviewAdminResponse> layDanhSachDanhGia(String q, Integer soSao, String trangThai, String sort, int page, int size) {
    ...
    @Transactional
    public ResponseEntity<?> phanHoiDanhGia(Long id, Map<String, String> payload) {
